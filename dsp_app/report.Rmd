...
When multiple methods are used in measurements, such as bulk density, a ranking was used to alter how the methods are analyzed.  For this example, core bulk density was favored because it was done on nearly all samples.
