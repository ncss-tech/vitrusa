...
test[vars] <- apply(ac_wide[vars2], 2, function(x) prettyNum(sum(as.numeric(gsub(",", "", x)), na.rm = TRUE), 
                                                            big.mark = ",", 
